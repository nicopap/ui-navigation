...
//!   [`Name`](https://docs.rs/bevy/0.7.0/bevy/core/struct.Name.html) matches
...
/// focusable by [`Name`](https://docs.rs/bevy/0.7.0/bevy/core/struct.Name.html)
///
...
///   have access to the [`Entity`](https://docs.rs/bevy/0.7.0/bevy/ecs/entity/struct.Entity.html)
