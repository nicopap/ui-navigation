...
Check out the [`examples`](https://github.com/nicopap/ui-navigation/tree/v0.13.1/examples) directory for bevy examples.
...
feature. But you won't be able to use [`FocusableButtonBundle`](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/components/struct.FocusableButtonBundle.html), and you'll have
to use [`generic_default_mouse_input`](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/systems/fn.generic_default_mouse_input.html) for mouse input and define special spacial
components to get it working.


## Usage

See [this example](https://github.com/nicopap/ui-navigation/tree/v0.13.1/examples/simple.rs)
for a quick start guide.

[The crate documentation is extensive](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/),
but for practical reason doesn't include many examples. This page contains most of the
doc examples, you should check the [examples directory](https://github.com/nicopap/ui-navigation/tree/v0.13.1/examples)
...
with [`FocusableButtonBundle`](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/components/struct.FocusableButtonBundle.html).
...
Use the [`InputMapping`](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/systems/struct.InputMapping.html)
resource to change keyboard and gamepad button mapping.

Check the [`examples directory`](https://github.com/nicopap/ui-navigation/tree/v0.13.1/examples)
...
[`NavEvent`](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/events/enum.NavEvent.html) event queue:
...
[`Focusable`](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/struct.Focusable.html)
...
`Focusable` as
[`Focusable::lock`](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/struct.Focusable.html#method.lock).
...
[`NavRequest::Free`](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/events/enum.NavRequest.html#variant.Free).
...
[`NavRequest::FocusOn`](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/events/enum.NavRequest.html#variant.FocusOn).
...
[`NavMenu`](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/enum.NavMenu.html).
...
3. to the `NodeBundle` containing all the options menu
   ...
   * [`NavMenu::Bound2d.reachable_from_named("opt_btn_name")`](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/enum.NavMenu.html#method.reachable_from_named)
     if you opted for adding the `Name` component.
   * [`NavMenu::Bound2d.reachable_from(opt_btn)`](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/enum.NavMenu.html#method.reachable_from)
...
access it by sending [`NavRequest::Action`](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/events/enum.NavRequest.html#variant.Action)
when `options_button` is focused, or by sending a
[`NavRequest::FocusOn(entity)`](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/events/enum.NavRequest.html#variant.FocusOn) where `entity` is any of `graphics_option`, `audio_options` or `input_options`.
...
module](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/systems/index.html).
...
A [`NavMenu`](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/enum.NavMenu.html)
...
* `NavMenu::*Scope` creates a "scope" menu that catches
  [`NavRequest::ScopeMove`](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/events/enum.NavRequest.html#variant.ScopeMove)
...
See the [`NavMenu`](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/enum.NavMenu.html)
documentation or the ["ultimate" menu navigation
example](https://github.com/nicopap/ui-navigation/blob/v0.13.1/examples/ultimate_menu_navigation.rs)
for details.
...
[`NavEvent::FocusChanged`](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/events/enum.NavEvent.html#variant.FocusChanged)
originated, you can use one of the [`marking`](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/bundles/struct.MenuSeed.html#method.marking) methods on the `NavMenu` seeds.

A usage demo is available in [the `marking.rs` example](https://github.com/nicopap/ui-navigation/tree/v0.13.1/examples/marking.rs).
...
* `0.9.0`: Add [`Focusable::cancel`](https://docs.rs/bevy-ui-navigation/0.13.1/bevy_ui_navigation/struct.Focusable.html#method.cancel) (see documentation for details); Add warning
